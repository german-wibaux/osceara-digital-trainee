...
@Component({
  selector: 'app-afiliados-empadronados',
  templateUrl: './afiliados-empadronados.component.html',
  styleUrls: ['./afiliados-empadronados.component.scss']
})
export class AfiliadosEmpadronadosComponent {
